...
defined('BASE_URL') or define('BASE_URL', (is_https() ? 'http://' : 'http://') . $_SERVER['HTTP_HOST'] . dirname($_SERVER['SCRIPT_NAME']) . '/');
...
$config['sentry_enviroments'] = $_SERVER['APP_ENV'];
$config['sentry_client'] = 'https://11e6a59d5ad54dd2930448fd5c06469b@sentry.io/1455562';
