              ...
              <table id="trnstable" class="table table-bordered table-striped">
				...
				<tr>
                  ...
                  <td><?php
					...
					echo str_repeat('&nbsp;',1);
					echo anchor(base_url(BASE_FOLDER_TRANS.'vehicles/deletetblrecord/'.$row_id),"<i class='fa fa-trash'></i> Eliminar",array('class'=>'btn btn-danger mr-deleterow btn-sm','tbl_name'=>'vehicle_documents'));
					}
