...
?>
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Documentos del Conductor</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="trnstable" class="table table-bordered table-striped">
				...
				<tr>
				  ...
				  ?></td>
                  <td><?php
					echo anchor(base_url(BASE_FOLDER_TRANS.'drivers/viewdocument/'.$row_id),"<i class='fa fa-eye'></i> Ver",array('class'=>'btn btn-info btn-sm'));
