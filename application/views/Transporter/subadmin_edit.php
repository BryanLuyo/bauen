 ...
 <!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?=base_url(BASE_FOLDER_TRANS.'subadmins')?>">Sub Adminstradores</a></li>
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Ingrese los nombres" value="<?=set_value('first_name',$subadmin['first_name'])?>">
				  <?=form_error('first_name')?>
                </div>
				<div class="form-group">
                  <label for="last_name">Apellidos</label>
                  <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Ingrese los apellidos" value="<?=set_value('last_name',$subadmin['last_name'])?>">
                </div>
                <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input type="text" class="form-control" id="dni_no" name="dni_no" placeholder="Ingrese el número de DNI" value="<?=set_value('dni_no',$subadmin['dni_no'])?>">
				  <?=form_error('dni_no')?>
                </div>
