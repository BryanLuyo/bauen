      ...
      <div class="container">
          <div class="row">
              <div class="col-sm-5 contact">
                  ...
                  <p>
                    Av. Javier Prado Oeste 2061<br>San Isidro - Lima, Perú.
                  </p>
                  {{-- <p>{{trans('pdg.13') }}</p>
                  <p>{{trans('pdg.14') }}</p>
                  <p>{{trans('pdg.15') }} </p> --}}
              ...
              <div class="col-sm-5 contact-form">
                  ...
                  <form action="{{url('send-your-message')}}" method="post" name="send_your_message">
                      ...
                      <div class="form-group"><input type="text" name="client_name" class="form-control" placeholder="{{trans('pdg.16') }}"> </div>
                      <div class="form-group"><input type="email" name="client_email" class="form-control" placeholder="{{trans('pdg.17') }}"> </div>
                      <div class="form-group">
                          <textarea type="text" name="client_message" class="form-control" rows="4" placeholder="{{trans('pdg.18') }}"></textarea> 
                      </div>
                      <div class="form-group">
                          <input type="submit" value="{{trans('pdg.19') }}" class="btn btn-send">
                      </div>
                  </form>
              </div>
          </div>
