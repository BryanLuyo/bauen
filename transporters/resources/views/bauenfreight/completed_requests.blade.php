...
@section('title')
<title>Bauen | Solicitudes completadas</title>
@endsection
...
<div class="right-body">
  ...
  <div class="tab-content">
    ...
    <!-- <div class="row">
      <div class="col-xs-12 pb-4">
          <div class="main-breadcrumb">
              Dashboard <i class="fa fa-angle-right"></i> Ordenes Completadas
          </div>
      </div> -->
    </div>
	<div class="row">
      <div class="col-xs-12 pb-4">
	         ...
	         <form id="formSearch" name="formSearch" action="{{url('completed-requests')}}" method="GET">
			 <div class="form-group form-group-lg" style="margin-bottom: 0px !important;">
					<div class="input-group">
						...
						<input type="text" style="background-color: #eeededcf; border: 0px;" class="form-control" name="search" id="search" placeholder="Buscar palabra clave (Empresa,Código de asignacion, RQ, Origen, Destino, Descripción)" onkeyup="buscar()">
					</div>
               </div>
			  </form> 
	  </div>
    ...
    <div class="transit-request" id="search_request">
...
<script>
  ...
  function buscar() {
	  ...
	  $.ajax({
      url: "{{url('completed-requests-search')}}",
      type: 'GET',
      data: { search: search },
      success : function(data) {
         $('#search_request').html(data)
      }
    })
