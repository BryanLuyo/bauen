...
<head>
    ...
    <?php
        ...
        $message1 = 'Bienvenido. Usted ha recibido este mensaje porque se ha generado una cuenta de subadministrador en Bauen. Haga clic en el siguiente enlace para activar su cuenta.';
        ...
        if(Session::has('locale') && (Session::get('locale')=="en" || Session::get('locale')=="ar")){ 
            ...
            $message1 = 'Welcome. You have received this message because you have created a sub-administrator account in Bauen. Please, click on the following link to activate your account.';
                    ...
                    <div style="background:#fff;font-family:Arial,Helvetica,sans-serif;width:100%;">
                        ...
                        <div style="width:100%;text-align:center">
                            <table style="width:100%">
                                <tr style="width:100%">
                                    <td aling="center">
                                      <a href="<?php echo $data['active_account']; ?>" style="font-size: 16px;line-height: 20px;padding: 0;margin: 0;display: inline-block;border-radius: 5px;background-color: #fec40e;padding: 10px 15px;font-weight: 700;color:#fff;text-decoration:none">Activar cuenta</a>
                                      <p>
                                        <small>Si el botón no funciona, ingrese directamente al enlace: <a href="<?php echo $data['active_account']; ?>"><?php echo $data['active_account']; ?></a>
                                        </small>
                                      </p>
                                    </td>
                                </tr>
